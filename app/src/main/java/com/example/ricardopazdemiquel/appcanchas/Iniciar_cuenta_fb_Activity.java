...
public class Iniciar_cuenta_fb_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void Guardar() {
        ...
        new Registrar(id , nombreV , apellidoV , correoV ,telefonoV ).execute();
    }

    private class Registrar extends AsyncTask<Void, String, String> {
        private ProgressDialog progreso;
        private String  id , nombre ,  apellidos, correo , telefono  ;
        public Registrar(String id ,String nombre ,String apellidos , String correo , String telefono ) {
            this.id= id;
            this.nombre= nombre;
