...
public class eliminar_reserva_dialog extends DialogFragment implements View.OnClickListener {
    ...
    @SuppressLint("ValidFragment")
    public eliminar_reserva_dialog(int tipo, double creditos) {
        this.tipo = tipo;
    ...
    public AlertDialog createLoginDialogo() {
        ...
        View v = inflater.inflate(R.layout.eliminar_reserva_dialog, null);
        builder.setView(v);
